...
<html>
<head>
  <title>Business Manager | Reorder Level Changes</title>
  <meta charset="utf-8">
...
<!---------------------------------------------------- LOCKSCREEN MENU -------------------------------------------------------------->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          <i class="fa fa-bar-chart"></i> <b>Reorder Level Changes</b>
        <!-- <small>Supplies</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Dashboard</a></li>
         <li><i class="fa fa-cubes"></i> Inventory</a></li>
        <li class="active"><i class="fa fa-bar-chart"></i>Reorder Level Changes</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box-body">
        <table id="example" class="table table-bordered table-striped">
         <?php
                  $conn =mysqli_connect("localhost","root","", "itproject") or die('Error connecting to MySQL server.');
                  $sql = "SELECT * FROM reorderlevelupdate";
                  $result = $conn->query($sql);    
                ?>
          <thead>
            <tr>
