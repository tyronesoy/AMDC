  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <!-- <h3 class="box-title">Data Table With Full Features</h3> -->
                <table style="float: left;">
                    <tr>
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="<?php echo 'issuedSupplies' ?>">All branches</a></li>
                          <li><a href="<?php echo 'issuedBaguio' ?>">Baguio City</a></li>
                        <li><a href="<?php echo 'issuedSLU' ?>">SLU Hospital</a></li>
                        </ul>
                      </div></th>
                        <th> <div class="btn-group">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="../examples/invoice-print6.php" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>s
        </div>
      </div>
