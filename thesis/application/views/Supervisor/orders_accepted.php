  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-check"></i>Accepted Orders</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
                   ...
                   <table id="example" class="table table-bordered table-striped">
                      <?php
                        $conn =mysqli_connect("localhost","root","", "itproject") or die('Error connecting to MySQL server.');
                        $sql = "SELECT * FROM inventory_order JOIN inventory_order_supplies USING(inventory_order_uniq_id) WHERE inventory_order_name ='".$this->session->userdata('fname').' '.$this->session->userdata('lname')."' AND inventory_order_status = 'Accepted' GROUP BY inventory_order_id ";
                        $result = $conn->query($sql);    
                      ?>
                      <thead>
                          <tr>
