...
if(isset($_POST['deliveryRestore'])){
    ...
    if($result_update){
        ...
        mysqli_select_db($conn, "itproject");
        $notif = "insert into logs (log_date,log_description,user,module) VALUES ('".$datetoday."','A delivery  with id# ".$new_id." has been restored','".$this->session->userdata('fname')." ".$this->session->userdata('lname')."','".$this->session->userdata('type')."')";
