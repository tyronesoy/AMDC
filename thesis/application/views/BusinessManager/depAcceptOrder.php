...
<form name="form1" id="user_form" method="post" action="dashboard/addUser" enctype="multipart/form-data">
  ...
  <!---------------------------------------------------- USER ACCOUNTS MENU -------------------------------------------------------------->
    ...
    <!---------------------------------------------------- SUPPLIES MENU -------------------------------------------------------------->
      ...
      <li class="active"><a href="<?php echo 'departmentsOrder' ?>"><i class="fa fa-list"></i>Departments Order</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-list"></i> Departments Order</a></li>
        <li class="active"><i class="fa fa-check"></i> Accepted</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example" class="table table-bordered table-striped">
                <?php
                  $conn =mysqli_connect("localhost","root","", "itproject") or die('Error connecting to MySQL server.');
                  $sql = "SELECT * FROM inventory_order JOIN inventory_order_supplies USING(inventory_order_uniq_id) WHERE inventory_order_status = 'Accepted' GROUP BY inventory_order_id";
                  $result = $conn->query($sql);    
                ?>
                <thead>
                  <tr>
...
if(isset($_POST['btnEdit'])){
    ...
    if($result_update){
        ...
        mysqli_select_db($conn, "itproject");
        $notif = "insert into logs (log_date,log_description,user,module) VALUES ('".$datetoday."','Department order ID #".$new_id." has been edited with remarks ".$new_remarks."','".$this->session->userdata('fname')." ".$this->session->userdata('lname')."','".$this->session->userdata('type')."')";
