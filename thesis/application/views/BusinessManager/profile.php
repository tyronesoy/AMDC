...
<html>
<head>
  <title>Business Manager | Profile</title>
  <meta charset="utf-8">
...
<!---------------------------------------------------- LOCKSCREEN MENU -------------------------------------------------------------->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-address-book"></i> <b>Profile</b>
        <!-- <small>advanced tables</small> -->
      </h1>
        
     <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active"><i class="fa fa-address-book"></i> Profile</li>
      </ol>
    </section>
    <!-- Main content -->
    ...
    <center>
    <form name="form12" id="user_form2" method="post" action="profile/editor" style="width:60%;">
                                        <!-- end of modal header -->
                                        <div class="modal-body">
                                        <div class="box-header">
                                          <div class="margin">
