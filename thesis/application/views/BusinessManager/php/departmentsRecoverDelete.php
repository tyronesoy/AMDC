    ...
    <form class="form-horizontal" method="post" action ="">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="departmentsRecover"><button type="button" class="btn btn-danger">Cancel</button> </a>
                <button type="submit" class="btn btn-success" name="depRestore">Restore</button>
            </div>
        </div>
    </form>
<?php
