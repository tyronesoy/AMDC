   ...
   <form class="form-horizontal" method="post" action ="">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="officeSupplies"><button type="button" class="btn btn-danger pull-left"><i class="fa fa-times-circle"></i> Cancel</button> </a>
                <button type="submit" class="btn btn-primary" name="offEdit"><i class="fa fa-save"></i> Save</button>
            </div>
        </div>
    </form>
