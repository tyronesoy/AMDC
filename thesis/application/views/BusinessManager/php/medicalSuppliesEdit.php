    ...
    <form class="form-horizontal" method="post" action ="">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h3 class="modal-title"><b>Update Supply Details</b></h3></center>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="medEdit"><i class="fa fa-times-save"></i> Save</button>
            </div>
        </div>
    </form>
<?php
