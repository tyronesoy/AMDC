          ...
          <div class="box">
              ...
              <!-- <h3 class="box-title">Data Table With Full Features</h3> -->
                <table style="float: left;">
                    <tr>
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="../issuedSupplies.php">All</a></li>
                          <li><a href="issuedToEndoscopy.php">Endoscopy</a></li>
                          <li><a href="IssuedToImaging.php">Imaging</a></li>
                          <li><a href="IssuedToLaboratory.php">Laboratory</a></li>
                        </ul>
                      </div></th>
                    </tr>
                </table>      
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <?php
                    require_once("../../../../db.php");
                    $sql = "SELECT * FROM issuedsupplies where department_name like '%Cardiac%'";
                    $result = $conn->query($sql);
                  ?>
                    <thead>
                    <tr>
