...
$datetoday = date('Y\-m\-d\ H:i:s A');
    $con2 =mysqli_connect("localhost","root","");
        ...
        $notif1 = "insert into logs (log_date,log_description,user,module) VALUES ('".$datetoday."','A supply has been returned with quantity ".qtyReturn."','".$this->session->userdata('username')."','".$this->session->userdata('type')."')";
