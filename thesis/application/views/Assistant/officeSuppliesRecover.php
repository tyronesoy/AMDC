...
<html>
<head>
  <title>Assistant| Office Supplies Recover</title>
  <meta charset="utf-8">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a href="officeSupplies" style="color:white;"><button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-arrow-left"></i>
              </button></a>
...
if(isset($_POST['offRestore'])){
    ...
    if($result_update){
        ...
        mysqli_select_db($conn, "itproject");
        $notif = "insert into logs (log_date,log_description,user,module) VALUES ('".$datetoday."','An office supply with id# ".$new_id." has been recovered','".$this->session->userdata('fname')." ".$this->session->userdata('lname')."','".$this->session->userdata('type')."')";
