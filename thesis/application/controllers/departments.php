...
class Departments extends CI_Controller {
	...
	public function getBagdep(){
		$this->load->view('BusinessManager/branchBaguio');
	}
	public function fetchBagdep(){
		$this->load->view('BusinessManager/php/departmentsBaguioFetch');
	}
	public function getLadep(){
		$this->load->view('BusinessManager/branchLA');
	}
}
